...
const et: Dictionary = {
  ...
  pricing: {
    ...
    colService: "Nimetus",
    colPrice: "Hind",
    notesTitle: "Üldised tingimused",
    important: [
      "Teenuse minimaalne tasu on esimese töötunni hind.",
      ...
      "Loetlemata teenuseid hinnastatakse eraldi.",
      "Suuremahuliste tööde puhul on hind läbiräägitav.",
      ...
      "Allahindlus ei kehti kaamera (torustiku) ülevaatusele.",
      "Akti koostamine toimub eraldi kokkuleppel, hinnad alates 15 € + km.",
      "Allahindlused ei kehti välitööde puhul (kanalisatsiooni-, vee-, küttetorude, kaevude, pumpade jm vahetus).",
      "Tunnihinnad kehtivad ühele spetsialistile. Kui vajalik on kaks või enam inimest, arvestatakse aega vastavalt.",
      "Kui töömasin peab kasutama tasulist parkimist, lisatakse arvele tegelik parkimiskulu. Sellest teavitatakse teid ette.",
    ],
  },
  contactPage: {
...
const en: Dictionary = {
  ...
  pricing: {
    ...
    colService: "Service",
    colPrice: "Price",
    notesTitle: "General terms",
    important: [
      "The minimum service fee is the price of the first working hour.",
      ...
      "Services not listed in the price list are priced separately.",
      "For large-scale work, the price is negotiable.",
      ...
      "Discounts do not apply to camera (pipe) inspections.",
      "A work report is drawn up by separate agreement, prices from €15 + km.",
      "Discounts do not apply to field work (replacement of sewage, water, or heating pipes, wells, pumps, etc.).",
      "Hourly rates apply per specialist. If two or more people are required, time is calculated accordingly.",
      "If the work vehicle must use paid parking, the actual parking cost is added to the invoice. You will be notified of this in advance.",
    ],
  },
  contactPage: {
...
const ru: Dictionary = {
  ...
  pricing: {
    ...
    colPrice: "Цена",
    notesTitle: "Общие условия",
    important: [
      "Минимальная плата за услугу — это стоимость первого рабочего часа.",
      ...
      "Услуги, не указанные в прайс-листе, оцениваются отдельно.",
      "Для крупных работ цена оговаривается отдельно.",
      ...
      "Скидка не распространяется на осмотр трубопровода камерой.",
      "Составление акта производится по отдельной договорённости, цены от 15 € + км.",
      "Скидки не действуют на выездные работы (замена канализационных, водопроводных, отопительных труб, колодцев, насосов и т. д.).",
      "Почасовые ставки действуют на одного специалиста. Если требуется два и более человек, время рассчитывается соответственно.",
      "Если рабочей машине необходимо использовать платную парковку, к счёту добавляется фактическая стоимость парковки. Об этом вас уведомят заранее.",
    ],
  },
  contactPage: {
